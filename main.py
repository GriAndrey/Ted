...
if not tables or ('subtitles' not in tables[0]):
    cur.execute(
        ...
        (videoId integer, duration integer, content text, startOfParagraph integer, startTime integer, videoLink text, videoName text, videoAge integer, videoLocation text)
        ''')
